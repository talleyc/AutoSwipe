...
class Card {
    ...
    var xDelta = 0
    var yDelta = 0
    let cardWidth = UIScreen.mainScreen().bounds.width * 0.7
    ...
    init(url: String, xD: Int, yD: Int) {
        ...
        self.yDelta = yD
        self.imageURL = url
        self.imageView = UIImageView(frame: CGRect(x: 1, y: 1, width: cardWidth - 2, height: cardHeight*0.65))
            ...
            if error == nil {
                ...
                if image != nil {
                    ...
                    dispatch_async(dispatch_get_main_queue(), {
                        // TODO: the Resizing is not working. Why?!?!?!
                        self.imageView.image = ResizeImage(image!, self.imageView.frame.size)
